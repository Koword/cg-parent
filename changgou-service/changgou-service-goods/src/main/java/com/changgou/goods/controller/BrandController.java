...
public class BrandController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) Brand brand, @PathVariable int page,
    ...
    public Result findBrandByCategory(@PathVariable(value = "id") Integer categoryId) {
        ...
        return new Result(true, StatusCode.OK, "根据分类信息查询品牌列表成功!", brandList);
    }
