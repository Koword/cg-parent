...
public class SkuController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) Sku sku, @PathVariable int page,
    ...
    public Result findSkusByStatus(@PathVariable(value = "status") String status) {
        List<Sku> skuList = skuService.findSkusByStatus(status);
        return new Result(true, StatusCode.OK, "根据状态查询sku成功!", skuList);
    }
