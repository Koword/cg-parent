...
public class TemplateController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) Template template, @PathVariable int page,
    ...
    /**
     * @Description 根据分类查询模板数据
     * @Author tangKai
     * @Date 17:44 2019/12/27
     * @Param [id]
    ...
    public Result<Template> findByCategory(@PathVariable(value = "id") Integer id) {
        ...
        return new Result<Template>(true, StatusCode.OK, "根据分类id查询模板成功!", template);
